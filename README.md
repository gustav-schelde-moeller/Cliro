...
Uden dette virker appen 100% fint — virksomhedslisten vokser bare ikke af sig selv. Med det sat op, søger et automatisk job på nettet efter op til 3 nye danske virksomheder med en ægte nyhed offentliggjort samme dag ad gangen, og tilføjer dem til listen (eksisterende virksomheder bliver aldrig rettet eller slettet). Det kører 4 gange hver hverdag (kl. 06, 08, 10 og 12 UTC) — opdelt i flere mindre kørsler, fordi Vercels gratis Hobby-plan sætter en hård grænse på 300 sekunder pr. kørsel, og en fuld same-day-søgning ikke altid kan nå at blive færdig inden for det selv med et lille mål. Samlet giver det op til ca. 12/dag. Kører ikke i weekenden. Bruger Claude Sonnet med tænke-funktion slået fra (for at holde sig under tidsgrænsen).

**Pris er endnu ikke bekræftet ved en succesfuld kørsel** — tidligere estimater (50-110 kr/dag) var baseret på et større mål (20/dag) og andre indstillinger, før flere runder af fejlsøgning skar det ned. Første rigtige måling mangler stadig.
